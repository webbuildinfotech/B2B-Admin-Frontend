...
import { deleteMultipleFaq } from 'src/store/action/settingActions';
...
export function FAQsListView() {
  ...
  const handleDeleteSelectedRows = useCallback(async () => {
    ...
    try {
      await dispatch(deleteMultipleFaq(selectedRows));
      setSelectedRows([]);
      fetchFAQData(); // Refresh data after deletion
      confirm.onFalse();
    } catch (error) {
  ...
  }, [selectedRows, fetchFAQData, confirm]);
