...
import { LogoLoader } from '../logo/logoLoader'; // Corrected import path
  ...
  return (
    ...
    >
      ...
      >
        ...
        {logo ?? <img src="/logo.png" alt="logo" width={170} height={50} />}
      </Box>
...
export function AnimateLogo3({ logo, sx, ...other }) {
  return (
    <Box
      sx={{
        width: 120,
    ...
    >
      <Box
        ...
        sx={{ display: 'inline-flex' }}
      >
        {logo ?? <LogoLoader disableLink width={64} height={64} />}
      </Box>
      ...
      <Box
        ...
        sx={{
          ...
          width: 'calc(100% - 20px)',
          height: 'calc(100% - 20px)',
          border: (theme) => `solid 3px ${theme.palette.error.main}`, // Updated to red
        }}
      />
      ...
      <Box
        ...
        sx={{
          ...
          height: 1,
          position: 'absolute',
          border: (theme) => `solid 8px ${theme.palette.error.main}`, // Updated to red
        }}
      />
    </Box>
  );
